...
import com.afree.canary.widget.recycler.RecyclerItemTouchCallback;
 ...
 */
public class RecyclerItemOprationFragment extends BaseFragment {
  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    RecyclerItemTouchCallback itemTouchHelper = new RecyclerItemTouchCallback(adapter);
