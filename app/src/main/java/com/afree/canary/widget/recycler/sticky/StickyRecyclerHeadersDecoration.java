...
import com.afree.canary.widget.recycler.sticky.caching.HeaderProvider;
import com.afree.canary.widget.recycler.sticky.caching.HeaderViewCache;
import com.afree.canary.widget.recycler.sticky.calculation.DimensionCalculator;
import com.afree.canary.widget.recycler.sticky.rendering.HeaderRenderer;
import com.afree.canary.widget.recycler.sticky.util.LinearLayoutOrientationProvider;
import com.afree.canary.widget.recycler.sticky.util.OrientationProvider;
...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
  ...
  private StickyRecyclerHeadersDecoration(StickyRecyclerHeadersAdapter adapter,
    ...
    this(adapter, orientationProvider, dimensionCalculator,
  ...
  public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
    ...
    for (int i = 0; i < childCount; i++) {
      ...
      boolean hasStickyHeader =
          mHeaderPositionCalculator.hasStickyHeader(itemView,
              mOrientationProvider.getOrientation(parent), position);
      if (hasStickyHeader
          || mHeaderPositionCalculator.hasNewHeader(position,
              mOrientationProvider.isReverseLayout(parent))) {
